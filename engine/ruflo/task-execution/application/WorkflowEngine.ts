...
export class WorkflowEngine {
  ...
  async shutdown(): Promise<void> {
    for (const [_id, execution] of this.workflows.entries()) {
  ...
  async executeTask(task: RufloTask, agentId: string): Promise<TaskResult> {
  ...
  async executeParallel(tasks: RufloTask[]): Promise<TaskResult[]> {
